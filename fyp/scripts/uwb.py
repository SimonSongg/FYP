...
while not rospy.is_shutdown():
    ...
    if line.startswith('mc'):
        print(line)
        uwb_data.uwb_info[0] = float(line[3:5])
        uwb_data.uwb_info[1] = int(line[6:14],16) / 1000
        uwb_data.uwb_info[2] = int(line[15:23],16) / 1000
        uwb_data.uwb_info[3] = int(line[24:32],16) / 1000
        uwb_data.uwb_info[4] = int(line[33:41],16) / 1000
